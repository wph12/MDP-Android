...
public class MainActivity extends AppCompatActivity {
    ...
    BroadcastReceiver messageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            String category = obj.getJsonObject("\"cat\"").getString();
        	JSONObject  value = obj.getJsonObject("\"value\"");
            switch(category) {
            case "location":
            	int xPos = (int) Float.parseFloat(value.getJsonObject("\"x\"").getString());
            	int yPos = (int) Float.parseFloat(value.getJsonObject("\"y\"").getString());
            	double bearing;
            	switch(value.getJsonObject("\"d\"").getString()) {
            	case "0": bearing = 90;
            	case "2": bearing = 0;
            	case "4": bearing = 270;
            	case "6": bearing = 180;
            ...
            case "image-rec":
            	gridMap.updateImageID(value.getJsonObject("\"obstacle_id\"").getString(), value.getJsonObject("\"image_id\"").getString());
            }
            /*
